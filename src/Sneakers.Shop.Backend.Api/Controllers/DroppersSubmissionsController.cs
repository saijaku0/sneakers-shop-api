...
{
    /// <summary>
    /// Controller for managing dropper user submissions, including creation, retrieval, update, and deletion operations
    /// for the authenticated dropper.
    /// </summary>
    /// <remarks>All actions require the user to be authenticated and authorized with the Dropper role.
    /// Endpoints enforce role-based access and return appropriate HTTP status codes for authorization, validation, and
    /// resource state errors.</remarks>
